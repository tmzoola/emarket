...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('item', '0002_rename_category_categorymodel'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='item.categorymodel')),
